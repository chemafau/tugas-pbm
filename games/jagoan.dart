...
class Jagoan {
    ...
    // member berupa objek
    late Jubah jubah;        // relasi asosiasi, jagoan pakai jubah
    late Senjata senjata;    // relasi asosiasi, jagoan punya senjata
    
    Jagoan(this.nama, this.kesehatanDasar, this.kekuatanDasar, this.derajat, this.kenaikanKekuatan,
      this.kenaikanKesehatan, this.hidup); 
